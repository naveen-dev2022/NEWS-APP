...
import 'package:getx_pattern/app/modules/channels/widgets/specific_source_builder.dart';
...
class _SpecificSourceState extends State<SpecificSource> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        body: Obx(() => controller!.isSourceInternetAvailable.value
            ? NestedScrollView(
                            ...
                            Container(
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  fit: BoxFit.fill,
                                  image:
                                      AssetImage('assets/images/source_bg.jpg'),
                                ),
                              ),
                            ),
                            Align(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                return Padding(
                                  ...
                                  child: Column(
                                    children: [
                                      SpecificSourceBuilder(
                                          data: controller!.specificSourceData
